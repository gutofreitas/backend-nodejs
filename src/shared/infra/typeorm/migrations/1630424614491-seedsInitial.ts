...
export class seedsInitial1630424614491 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "MOOVIN".accounts(id, "name", "accountTypeId", balance, "createdAt", "updatedAt") VALUES(1, 'Fulano', 1, 0, '2021-08-31 08:16:42.733', '2021-08-31 15:18:21.035');`);
    }
